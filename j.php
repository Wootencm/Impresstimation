...
<td><p class="text-center">Sales Rep First Name</p></td>
<td><p class="text-center">Sales Rep Last Name</p></td>
<td><p class="text-center">Summary</p></td>
...
<td><p class="text-center">'.$trow['first_name_sales_rep'].'</p></td>
<td><p class="text-center">'.$trow['last_name_sales_rep'].'</p></td>
<td align="center"><p class="text-center"><form method="POST" action="summary2.php"><div style="display:none"><input type=hidden size=0 name="id" value="'.$trow['id'];
